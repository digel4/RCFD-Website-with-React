        ...
        <div>
            <div className="hero">
                <div 
                    ...
                    style={{ 
                        backgroundImage: "url(../images/nae1.jpg)", 
                        backgroundSize: "cover", 
                        height: "100vh"
                    }} >
                </div>
                <div className="container hero-content-area container">
            ...
            <div className="bodycopyb container" id="learn-more">
                <h2 className="h2o text-center">The Big House, A Creative Business Support Programme.</h2>
