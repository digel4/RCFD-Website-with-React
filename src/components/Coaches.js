const Coaches = () => {
    return (
        ...
        <div className="container">
            ...
            <div id="coach-layout">
                <div id="bev" className="coachSection">
                    ...
                    <div className="coachText">
                        ...
                        <div className="coachBio bodycopyb">
                            ...
                            <p>In her spare time, Bev is a trustee of Derbyshire Dales CVS. She lives in Grindleford with her husband Tim and their two children.</p>

                            <p><a href=">https://www.linkedin.com/in/bev-shephard-30421920/">https://www.linkedin.com/in/bev-shephard-30421920/</a></p>
                            <p> <a href="https://haarlemartspace.co.uk/community/bev-sheperd">https://haarlemartspace.co.uk/community/bev-sheperd</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div id="bev" className="coachSection">
                    ...
                    <div className="coachText">
                        ...
                        <div className="coachBio bodycopyb">
                            ...
                            <p>Examples of her work appear on her website at <a href="www.camillaebrown.co.uk">www.camillaebrown.co.uk</a></p>
                        </div>
                    </div>
                </div>
                
                <div id="carol" className="coachSection">
                    <div className="coachImage">
                    ...
                    <div className="coachText">
                        ...
                        <div className="coachBio bodycopyb">
                            ...
                            <p>Current highlights include Writer/Illustrator-in-Residence, University of St Andrews.</p>

                            <p>Current teaching posts include:
                            -	Senior Lecturer in Illustration, School of Art & Design, Nottingham Trent University (2018-present)
                            -	Tutor, School of Illustration at the House of Illustration, London (2018-present)
                                -	Tutor, Nottingham Trent University (Childrens' Book Illustration; Graphic Novels; Reportage Illustration) (2016-present)</p>

                            <p><a href="https://caroladlam.co.uk/">https://caroladlam.co.uk/</a></p>
                        </div>
                    </div>
                </div>

                <div id="debbie" className="coachSection">
                    <div className="coachImage">
                ...
                <div id="tina" className="coachSection">
                    ...
                    <div className="coachText">
                        ...
                        <div className="coachBi bodycopybo">
                            ...
                            <p>Tina has knowledge of and has worked across all art forms, she has a BA in combined arts, a MA in Modern Literature, and a professional background in visual arts and design; but has recently supported the development of the performing arts, working for a theatre company for several years and supporting outdoor festival development – she is currently a board member of Wild Rumpus. Tina enjoys supporting artists and has worked as a mentor delivering one to one support, lectures and workshops for organisations such as The Royal College of Art and DeMontfort University.</p>

                            <p><a href="https://www.linkedin.com/in/tina-smith-805b855/">https://www.linkedin.com/in/tina-smith-805b855/</a></p>
                        </div>
                    </div>
                </div>

                <div id="ellen" className="coachSection">
                    <div className="coachImage">
